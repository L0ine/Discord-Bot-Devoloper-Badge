...
|----------|--------------|-------------|-----------|
| `DISCORD_BOT_TOKEN` | ✅ **JA** | Bot Token aus Developer Portal | `MTQxOTA...` |
| `CLIENT_ID` | ✅ **JA** | Application ID für Slash Commands | `999276298...` |
| `GUILD_ID` | ❌ Optional | Server ID (für lokale Commands) | `1256747980...` |
| `YOUR_USER_ID` | ❌ Optional | Deine User ID (für DMs) | `999276298...` |
